...
public class Gene extends ModelComponent {
	...
	/**
	 * calculates the regulation state of the gene; calls calcRegState() on regRegion; 
	 * smells like a donkey and looks like one too; eats 
	 * shoots 
	 * and leaves.
	 * 
	 */
	...
	public int getRegState() {
		//print(name + " with regState " + regState);
		return regState;
	}
