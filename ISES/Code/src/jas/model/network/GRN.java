...
public class GRN extends Thing {
	...
	public String getPropString() {
		...
		return 	"Average degree: " + avgDegree + "\n" +
				"Highest degree: " + highestDegree.getDegree() + " (" + highestDegree.getName() + ")\n" +
				"Lowest degree: " + lowestDegree.getDegree() + " (" + lowestDegree.getName() + ")\n" +
				"Highest indegree: " + highestIndegree.getIndegree() + " (" + highestIndegree.getName() + ")\n" +
				"Highest outdegree: " + highestOutdegree.getIndegree() + " (" + highestOutdegree.getName() + ")\n";
	}
