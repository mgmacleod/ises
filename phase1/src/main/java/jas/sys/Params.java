...
public class Params {
	 ...
	 * 
	 * the kFood1-9 parameters don't use the values set here; rather their values are set 
	 * dynamically based on the base probability (kFoodBase) and the factor (kFoodFactor) 
	 * by which kFoodBase is divided or multiplied randomly with frequency iFoodFlip
	 * 
	 */
	...
	// the gene regulatory network of the best model will be saved every x generations
	...
	// initialization methods, called from the 'presets' menu in the main application window
	// they only affect food availability rates; everything else will be as specified above
