...
import jas.model.cellular.Proteome;
...
public class ShapeDistribution {
	...
	public String getStatString() {
		String s = "numEntries=" + numEntries + ";mcShape=" + mcShape + ";lcShape=" + lcShape +
					";highestFreq=" + highestFreq + ";lowestFreq=" + lowestFreq + 
					";numPopulated=" + numPopulated + ";numUnpopulated=" + numUnpopulated + 
					";popUnpopRatio=" + String.format("%.3f", popUnpopRatio) + 
					";meanShape=" + String.format("%.3f", meanShape) +
					";meanFreq=" + String.format("%.3f", meanFreq) + 
					";sdShape=" + String.format("%.3f", sdShape) + 
					";sdFreq=" + String.format("%.3f", sdFreq);
		return s;
	}
