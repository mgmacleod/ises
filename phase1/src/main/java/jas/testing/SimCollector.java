...
public class SimCollector extends DataCollector {
	...
	public void writeToFile() {
		//print("numGenes: " + numGenes + "; nsGenome: " + numSitesGenome + "; nsGenes: " + numSitesGenes + "; fitness: " + fitness);
		
		//ArrayList<Integer> times = new ArrayList<Integer>(data.size());
		...
		try {
			...
			outputFile.println("numGenes: " + numGenes + "; nsGenome: " + numSitesGenome + "; nsGenes: " + numSitesGenes + "; fitness: " + fitness);
