...
public class ProteinSpecies extends ModelComponent {
	...
	public double calcAffinityFor(BindingSite bs) {
		...
		//print("calcAffinity: shape difference = " + d + "; ");
		if (d > Params.dMax)
			return 0.0;
		
		double b = (double)(d+1);
		double a = 1 / b;
		//print("calcAffinity: affinity = " + a);
		return a;
	...
	public void degrade() {
		...
		/*
		print("from ProteinSpecies.degrade()");
		print("copies = " + copies);
		print("count = " + count);
		print("degRate = " + degRate);
		print("degProb = " + degProb);
		*/
	...
	/**
	 * Sets the boundCopies of this protein species to 0 and stochastically degrades the number of
	 * available copies.
	 */
