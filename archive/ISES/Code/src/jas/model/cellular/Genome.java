...
import jas.model.network.InputNode;
import jas.model.network.OutputNode;
import jas.model.network.RegNode;
...
public class Genome extends ModelComponent {
	...
	///////////////////////  Instance variables  \\\\\\\\\\\\\\\\\\\\\\\\\\\\\
	protected Gene							fod1, fod2, fod3, fod4, fod5, fod6, fod7, fod8, fod9, 
											nrg1, nrg2, rcp1, rcp2;
	...
	public void translateInputGenes() {
		...
		//print("from Genome.translateInputGenes(): fod1 regstate: " + fod1.getRegState());
		for (Gene g: inputGenes) {
			if (g.isActive()) {
				g.translate();
	...
	public void translateRegulatedGenes() {
		...
		/*
		print("\nfrom Genome.translateRegulatedGenes()");
		print("num sites in syn1: " + syn1.getRegRegion().getSites().size());
		print("regState of syn1: " + syn1.getRegState());
		print("num sites in syn2: " + syn2.getRegRegion().getSites().size());
		print("regState of syn2: " + syn2.getRegState());
		*/
	}

	public void unbindAndDeactivate() {
		//if (getNumGenes() != allGenes.size())
			//print("Genome.unbindAndDeactivate: inconsistent gene numbers");
		for (Gene g: inputGenes) 
	...
	public void updateSitesList() {
		/*
		print("\n\nfrom Genome.updateSitesLists()");
		print("pre addAllSites()");
		printSites();
		*/
		sites = new ArrayList<BindingSite>();
		addAllSites();
